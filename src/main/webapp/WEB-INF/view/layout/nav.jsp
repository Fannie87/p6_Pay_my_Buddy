<nav class="navbar navbar-expand-lg bg-light container">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link active" aria-current="page" href="home" class="p-2">Home</a></li>
				<li class="nav-item"><a class="nav-link" href="transfer" class="p-2">Transfer</a></li>
